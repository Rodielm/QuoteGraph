...
import { useAuthorQuotes } from "@/features/authors/useAuthorQuotes";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6">
      ...
      {isLoading ? (
        ...
        <p className="text-sm text-muted-foreground">No quotes found for this author.</p>
      ) : (
